namespace CornellTech.Controller
{
    ...
    public class SceneController : MonoBehaviour
    {
        ...
        {
            m_myNetId = "dj336";    //TODO: Replace TA's NetID with your own ID.
        }
        ...
        protected void MoveTowardsOnClick()
        {
            ...
            Vector3 PlacetoGo = GetRandomVector3(c_PositionBound);
            SimpleAnimationData destination = new SimpleAnimationData(PlacetoGo, c_MoveTowardsSpeed);
            m_TextAnimator.StartAnimation(destination);
        }
